var e={d:(t,o)=>{for(var n in o)e.o(o,n)&&!e.o(t,n)&&Object.defineProperty(t,n,{enumerable:!0,get:o[n]})},o:(e,t)=>Object.prototype.hasOwnProperty.call(e,t)};void 0!==e&&Object.defineProperty(e,"p",{get:function(){try{if("string"!=typeof webpackResourceBasePath)throw new Error("WebpackRequireFrom: 'webpackResourceBasePath' is not a string or not available at runtime. See https://github.com/agoldis/webpack-require-from#troubleshooting");return webpackResourceBasePath}catch(e){return"#{root}/dist/webviews/"}},set:function(e){}});var t={};e.d(t,{$:()=>Eo});class o{constructor(e,t=!1,o=!1){this.method=e,this.reset=t,this.pack=o}}class n extends o{}class s extends o{}function r(e,t,o){e.method===t.method&&o(t.params,e)}const i=new n("webview/ready"),a=new n("webview/focus");new n("command/execute"),new n("configuration/preview"),new n("configuration/update"),new s("configuration/didChange"),new s("configuration/didPreview"),new s("webview/didOpenAnchor");const c=new n("welcome/configuration/update"),l=new s("welcome/didChange",!0);function d(e){const t=.001*performance.now();let o=Math.floor(t),n=Math.floor(t%1*1e9);return void 0!==e&&(o-=e[0],n-=e[1],n<0&&(o--,n+=1e9)),[o,n]}function h(e,t){let o,n,s,r,i;function a(e){const o=e-(n??0);return null==n||o>=t||o<0}function c(){const e=Date.now();if(a(e))l();else{i=setTimeout(c,t-(e-(n??0)))}}function l(){return i=void 0,o?function(){const t=o,n=s;return o=s=void 0,r=e.apply(n,t),r}():(o=s=void 0,r)}function d(...e){const l=Date.now(),d=a(l);return o=e,s=this,n=l,d&&null==i?(i=setTimeout(c,t),r):(null==i&&(i=setTimeout(c,t)),r)}return d.cancel=function(){null!=i&&clearTimeout(i),o=n=s=i=void 0},d.flush=function(){return null!=i?l():r},d.pending=function(){return null!=i},d}const f=",",p="",b="=",u="{",g="(",y=")",x=/\(([\s\S]*)\)/,v=/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,m=/\s?=.*$/;const C="";const w=new class{constructor(){this._isDebugging=!1,this.level=0,this._logLevel="off"}configure(e,t,o=!1){this.provider=e,this._isDebugging=o,this.logLevel=t}enabled(e){return this.level>=_(e)}get isDebugging(){return this._isDebugging}get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e,this.level=_(this._logLevel),"off"===e?(this.output?.dispose?.(),this.output=void 0):this.output=this.output??this.provider.createChannel(this.provider.name)}get timestamp(){return`[${(new Date).toISOString().replace(/T/," ").slice(0,-1)}]`}debug(e,...t){if(this.level<4&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??C}`)),this.isDebugging,null==this.output||this.level<4||this.output.appendLine(`${this.timestamp} ${o??C}${this.toLoggableParams(!0,t)}`)}error(e,t,...o){if(this.level<1&&!this.isDebugging)return;let n;if(n=null==t||"string"==typeof t?t:`${t.prefix} ${o.shift()??C}`,null==n){const t=e instanceof Error?e.stack:void 0;if(t){const e=/.*\s*?at\s(.+?)\s/.exec(t);null!=e&&(n=e[1])}}this.isDebugging,null==this.output||this.level<1||this.output.appendLine(`${this.timestamp} ${n??C}${this.toLoggableParams(!1,o)}${null!=e?`\n${String(e)}`:""}`)}log(e,...t){if(this.level<3&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??C}`)),this.isDebugging,null==this.output||this.level<3||this.output.appendLine(`${this.timestamp} ${o??C}${this.toLoggableParams(!1,t)}`)}warn(e,...t){if(this.level<2&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??C}`)),this.isDebugging,null==this.output||this.level<2||this.output.appendLine(`${this.timestamp} ${o??C}${this.toLoggableParams(!1,t)}`)}showOutputChannel(e){this.output?.show?.(e)}toLoggable(e,t){if("object"!=typeof e)return String(e);if(Array.isArray(e))return`[${e.map((e=>this.toLoggable(e,t))).join(", ")}]`;const o=this.provider.toLoggable?.(e);if(null!=o)return o;try{return JSON.stringify(e,t)}catch{return"<error>"}}toLoggableParams(e,t){if(0===t.length||e&&this.level<4&&!this.isDebugging)return C;const o=t.map((e=>this.toLoggable(e))).join(", ");return 0!==o.length?` — ${o}`:C}};function _(e){switch(e){case"off":default:return 0;case"error":return 1;case"warn":return 2;case"info":return 3;case"debug":return 4}}function k(e){let t;if("function"==typeof e){if(null==e.prototype?.constructor)return e.name;t=e.prototype.constructor.name??C}else t=e.constructor?.name??C;const o=t.indexOf("_");return-1===o?t:t.substr(o+1)}const $={enabled:e=>w.enabled(e)||w.isDebugging,log:(e,t,o,...n)=>{switch(e){case"error":w.error("",t,o,...n);break;case"warn":w.warn(t,o,...n);break;case"info":w.log(t,o,...n);break;default:w.debug(t,o,...n)}}},L=500,M=2**30,A=new Map;let S=0;function P(e){A.delete(e)}function E(e,t){if(null!=t)return{scopeId:t.scopeId,prefix:`${t.prefix}${e}`};const o=D();return{scopeId:o,prefix:`[${String(o).padStart(5)}] ${e}`}}function D(){return S===M&&(S=0),++S}var F=(e=>(e[e.Hash=35]="Hash",e[e.Slash=47]="Slash",e[e.Digit0=48]="Digit0",e[e.Digit1=49]="Digit1",e[e.Digit2=50]="Digit2",e[e.Digit3=51]="Digit3",e[e.Digit4=52]="Digit4",e[e.Digit5=53]="Digit5",e[e.Digit6=54]="Digit6",e[e.Digit7=55]="Digit7",e[e.Digit8=56]="Digit8",e[e.Digit9=57]="Digit9",e[e.Backslash=92]="Backslash",e[e.A=65]="A",e[e.B=66]="B",e[e.C=67]="C",e[e.D=68]="D",e[e.E=69]="E",e[e.F=70]="F",e[e.Z=90]="Z",e[e.a=97]="a",e[e.b=98]="b",e[e.c=99]="c",e[e.d=100]="d",e[e.e=101]="e",e[e.f=102]="f",e[e.z=122]="z",e))(F||{});const{fromCharCode:O}=String;new TextEncoder;function Z(e){const[t,o]=d(e);return 1e3*t+Math.floor(o/1e6)}const B="",H=Symbol("logInstanceNameFn");Symbol.dispose??=Symbol("Symbol.dispose"),Symbol.asyncDispose??=Symbol("Symbol.asyncDispose");class U{constructor(e,t,...o){let n;if(this._stopped=!1,this.logScope=null!=e&&"string"!=typeof e?e:E(e??""),n="boolean"==typeof t?.log?t.log?{}:void 0:t?.log??{},this.logLevel=t?.logLevel??"info",this.logProvider=t?.provider??$,this._time=d(),null!=n){if(!this.logProvider.enabled(this.logLevel))return;o.length?this.logProvider.log(this.logLevel,this.logScope,`${n.message??""}${n.suffix??""}`,...o):this.logProvider.log(this.logLevel,this.logScope,`${n.message??""}${n.suffix??""}`)}}get startTime(){return this._time}[Symbol.dispose](){this.stop()}elapsed(){const[e,t]=d(this._time);return 1e3*e+Math.floor(t/1e6)}log(e){this.logCore(e,!1)}restart(e){this.logCore(e,!0),this._time=d(),this._stopped=!1}stop(e){this._stopped||(this.restart(e),this._stopped=!0)}logCore(e,t){if(!this.logProvider.enabled(this.logLevel))return;if(!t)return void this.logProvider.log(this.logLevel,this.logScope,`${e?.message??""}${e?.suffix??""}`);const[o,n]=d(this._time),s=1e3*o+Math.floor(n/1e6),r=e?.message??"";this.logProvider.log(s>250?"warn":this.logLevel,this.logScope,`${r?`${r} `:""}[${s}ms]${e?.suffix??""}`)}}var z,R;function T(e,t){const o=e+t,n=t<0?o<0?0:o:o>255?255:o;return Math.round(n)}function V(e,t){return I(e,-t)}function I(e,t){const o=function(e){const t=oe(e);return null==t?null:[t.rgba.r,t.rgba.g,t.rgba.b,t.rgba.a]}(e);if(null==o)return e;const[n,s,r,i]=o,a=255*t/100;return`rgba(${T(n,a)}, ${T(s,a)}, ${T(r,a)}, ${i})`}function N(e,t){const o=J.from(e);return null==o?e:o.transparent(t/100).toString()}(R=z||(z={})).on=function(e,t,o,n){let s=!1;if("string"==typeof e){const r=function(t){const n=t?.target?.closest(e);null!=n&&o(t,n)};return document.addEventListener(t,r,n??!0),{dispose:()=>{s||(s=!0,document.removeEventListener(t,r,n??!0))}}}const r=function(e){o(e,this)};return e.addEventListener(t,r,n??!1),{dispose:()=>{s||(s=!0,e.removeEventListener(t,r,n??!1))}}},R.insertTemplate=function(e,t,o){const n=document.getElementById(e);if(t.replaceChildren(n?.content.cloneNode(!0)),t.className=n.className,null!=o?.visible){const e=t.querySelectorAll("[data-visible]");for(const t of e){const e=t.dataset.visible;e&&(o.visible[e]?t.style.display="initial":t.style.display="none")}}if(null!=o?.bindings){const e=t.querySelectorAll("[data-bind]");for(const t of e){const e=t.dataset.bind;if(!e)continue;const n=o.bindings[e];null!=n&&(t.textContent=String(n))}}},R.resetSlot=function(e){e.replaceChildren(),e.className=""};function j(e,t){const o=Math.pow(10,t);return Math.round(e*o)/o}class G{constructor(e,t,o,n=1){this._rgbaBrand=void 0,this.r=0|Math.min(255,Math.max(0,e)),this.g=0|Math.min(255,Math.max(0,t)),this.b=0|Math.min(255,Math.max(0,o)),this.a=j(Math.max(Math.min(1,n),0),3)}static equals(e,t){return e.r===t.r&&e.g===t.g&&e.b===t.b&&e.a===t.a}}class q{constructor(e,t,o,n){this._hslaBrand=void 0,this.h=0|Math.max(Math.min(360,e),0),this.s=j(Math.max(Math.min(1,t),0),3),this.l=j(Math.max(Math.min(1,o),0),3),this.a=j(Math.max(Math.min(1,n),0),3)}static equals(e,t){return e.h===t.h&&e.s===t.s&&e.l===t.l&&e.a===t.a}static fromRGBA(e){const t=e.r/255,o=e.g/255,n=e.b/255,s=e.a,r=Math.max(t,o,n),i=Math.min(t,o,n);let a=0,c=0;const l=(i+r)/2,d=r-i;if(d>0){switch(c=Math.min(l<=.5?d/(2*l):d/(2-2*l),1),r){case t:a=(o-n)/d+(o<n?6:0);break;case o:a=(n-t)/d+2;break;case n:a=(t-o)/d+4}a*=60,a=Math.round(a)}return new q(a,c,l,s)}static _hue2rgb(e,t,o){return o<0&&(o+=1),o>1&&(o-=1),o<1/6?e+6*(t-e)*o:o<.5?t:o<2/3?e+(t-e)*(2/3-o)*6:e}static toRGBA(e){const t=e.h/360,{s:o,l:n,a:s}=e;let r,i,a;if(0===o)r=i=a=n;else{const e=n<.5?n*(1+o):n+o-n*o,s=2*n-e;r=q._hue2rgb(s,e,t+1/3),i=q._hue2rgb(s,e,t),a=q._hue2rgb(s,e,t-1/3)}return new G(Math.round(255*r),Math.round(255*i),Math.round(255*a),s)}}class W{constructor(e,t,o,n){this._hsvaBrand=void 0,this.h=0|Math.max(Math.min(360,e),0),this.s=j(Math.max(Math.min(1,t),0),3),this.v=j(Math.max(Math.min(1,o),0),3),this.a=j(Math.max(Math.min(1,n),0),3)}static equals(e,t){return e.h===t.h&&e.s===t.s&&e.v===t.v&&e.a===t.a}static fromRGBA(e){const t=e.r/255,o=e.g/255,n=e.b/255,s=Math.max(t,o,n),r=s-Math.min(t,o,n),i=0===s?0:r/s;let a;return a=0===r?0:s===t?((o-n)/r%6+6)%6:s===o?(n-t)/r+2:(t-o)/r+4,new W(Math.round(60*a),i,s,e.a)}static toRGBA(e){const{h:t,s:o,v:n,a:s}=e,r=n*o,i=r*(1-Math.abs(t/60%2-1)),a=n-r;let[c,l,d]=[0,0,0];return t<60?(c=r,l=i):t<120?(c=i,l=r):t<180?(l=r,d=i):t<240?(l=i,d=r):t<300?(c=i,d=r):t<=360&&(c=r,d=i),c=Math.round(255*(c+a)),l=Math.round(255*(l+a)),d=Math.round(255*(d+a)),new G(c,l,d,s)}}function K(e,t){return t.getPropertyValue(e).trim()}const Q=class e{static from(t){return t instanceof e?t:oe(t)||e.red}static fromCssVariable(t,o){return oe(K(t,o))||e.red}static fromHex(t){return ne(t)||e.red}static equals(e,t){return!e&&!t||!(!e||!t)&&e.equals(t)}get hsla(){return this._hsla?this._hsla:q.fromRGBA(this.rgba)}get hsva(){return this._hsva?this._hsva:W.fromRGBA(this.rgba)}constructor(e){if(!e)throw new Error("Color needs a value");if(e instanceof G)this.rgba=e;else if(e instanceof q)this._hsla=e,this.rgba=q.toRGBA(e);else{if(!(e instanceof W))throw new Error("Invalid color ctor argument");this._hsva=e,this.rgba=W.toRGBA(e)}}equals(e){return null!=e&&(Boolean(e)&&G.equals(this.rgba,e.rgba)&&q.equals(this.hsla,e.hsla)&&W.equals(this.hsva,e.hsva))}getRelativeLuminance(){return j(.2126*e._relativeLuminanceForComponent(this.rgba.r)+.7152*e._relativeLuminanceForComponent(this.rgba.g)+.0722*e._relativeLuminanceForComponent(this.rgba.b),4)}static _relativeLuminanceForComponent(e){const t=e/255;return t<=.03928?t/12.92:Math.pow((t+.055)/1.055,2.4)}luminance(e){return function(e,t){if(0===t)return new J(new G(0,0,0,e.rgba.a));if(1===t)return new J(new G(255,255,255,e.rgba.a));const o=e.getRelativeLuminance();let n=20;const s=(e,o)=>{const r=e.mix(o,.5),i=r.getRelativeLuminance();return Math.abs(t-i)<1e-7||!n--?r:i>t?s(e,r):s(r,o)},r=(o>t?s(J.black,e):s(e,J.white)).rgba;return new J(new G(r.r,r.g,r.b,e.rgba.a))}(this,e)}getContrastRatio(e){const t=this.getRelativeLuminance(),o=e.getRelativeLuminance();return t>o?(t+.05)/(o+.05):(o+.05)/(t+.05)}isDarker(){return(299*this.rgba.r+587*this.rgba.g+114*this.rgba.b)/1e3<128}isLighter(){return(299*this.rgba.r+587*this.rgba.g+114*this.rgba.b)/1e3>=128}isLighterThan(e){return this.getRelativeLuminance()>e.getRelativeLuminance()}isDarkerThan(e){return this.getRelativeLuminance()<e.getRelativeLuminance()}lighten(t){return new e(new q(this.hsla.h,this.hsla.s,this.hsla.l+this.hsla.l*t,this.hsla.a))}darken(t){return new e(new q(this.hsla.h,this.hsla.s,this.hsla.l-this.hsla.l*t,this.hsla.a))}transparent(t){const{r:o,g:n,b:s,a:r}=this.rgba;return new e(new G(o,n,s,r*t))}isTransparent(){return 0===this.rgba.a}isOpaque(){return 1===this.rgba.a}opposite(){return new e(new G(255-this.rgba.r,255-this.rgba.g,255-this.rgba.b,this.rgba.a))}blend(t){const o=t.rgba,n=this.rgba.a,s=o.a,r=n+s*(1-n);if(r<1e-6)return e.transparent;const i=this.rgba.r*n/r+o.r*s*(1-n)/r,a=this.rgba.g*n/r+o.g*s*(1-n)/r,c=this.rgba.b*n/r+o.b*s*(1-n)/r;return new e(new G(i,a,c,r))}mix(e,t){return function(e,t,o){const n=e.rgba,s=t.rgba;return new J(new G(n.r+o*(s.r-n.r),n.g+o*(s.g-n.g),n.b+o*(s.b-n.b),n.a+o*(s.a-n.a)))}(this,e,t)}makeOpaque(t){if(this.isOpaque()||1!==t.rgba.a)return this;const{r:o,g:n,b:s,a:r}=this.rgba;return new e(new G(t.rgba.r-r*(t.rgba.r-o),t.rgba.g-r*(t.rgba.g-n),t.rgba.b-r*(t.rgba.b-s),1))}flatten(...t){const o=t.reduceRight(((t,o)=>e._flatten(o,t)));return e._flatten(this,o)}static _flatten(t,o){const n=1-t.rgba.a;return new e(new G(n*o.rgba.r+t.rgba.a*t.rgba.r,n*o.rgba.g+t.rgba.a*t.rgba.g,n*o.rgba.b+t.rgba.a*t.rgba.b))}toString(){return this._toString||(this._toString=function(e){if(e.isOpaque())return ee(e);return X(e)}(this)),this._toString}static getLighterColor(e,t,o){if(e.isLighterThan(t))return e;o=o||.5;const n=e.getRelativeLuminance(),s=t.getRelativeLuminance();return o=o*(s-n)/s,e.lighten(o)}static getDarkerColor(e,t,o){if(e.isDarkerThan(t))return e;o=o||.5;const n=e.getRelativeLuminance();return o=o*(n-t.getRelativeLuminance())/n,e.darken(o)}};Q.white=new Q(new G(255,255,255,1)),Q.black=new Q(new G(0,0,0,1)),Q.red=new Q(new G(255,0,0,1)),Q.blue=new Q(new G(0,0,255,1)),Q.green=new Q(new G(0,255,0,1)),Q.cyan=new Q(new G(0,255,255,1)),Q.lightgrey=new Q(new G(211,211,211,1)),Q.transparent=new Q(new G(0,0,0,0));let J=Q;function X(e){return`rgba(${e.rgba.r}, ${e.rgba.g}, ${e.rgba.b}, ${Number(e.rgba.a.toFixed(2))})`}function Y(e){const t=e.toString(16);return 2!==t.length?`0${t}`:t}function ee(e){return`#${Y(e.rgba.r)}${Y(e.rgba.g)}${Y(e.rgba.b)}`}const te=/^((?:rgb|hsl)a?)\((-?\d+%?)[,\s]+(-?\d+%?)[,\s]+(-?\d+%?)[,\s]*(-?[\d.]+%?)?\)$/i;function oe(e){if(0===(e=e.trim()).length)return null;if(e.charCodeAt(0)===F.Hash)return ne(e);const t=te.exec(e);if(null==t)return null;const o=t[1];let n;switch(o){case"rgb":case"hsl":n=[parseInt(t[2],10),parseInt(t[3],10),parseInt(t[4],10),1];break;case"rgba":case"hsla":n=[parseInt(t[2],10),parseInt(t[3],10),parseInt(t[4],10),parseFloat(t[5])];break;default:return null}switch(o){case"rgb":case"rgba":return new J(new G(n[0],n[1],n[2],n[3]));case"hsl":case"hsla":return new J(new q(n[0],n[1],n[2],n[3]))}return J.red}function ne(e){const t=(e=e.trim()).length;if(0===t)return null;if(e.charCodeAt(0)!==F.Hash)return null;switch(t){case 7:{const t=16*se(e.charCodeAt(1))+se(e.charCodeAt(2)),o=16*se(e.charCodeAt(3))+se(e.charCodeAt(4)),n=16*se(e.charCodeAt(5))+se(e.charCodeAt(6));return new J(new G(t,o,n,1))}case 9:{const t=16*se(e.charCodeAt(1))+se(e.charCodeAt(2)),o=16*se(e.charCodeAt(3))+se(e.charCodeAt(4)),n=16*se(e.charCodeAt(5))+se(e.charCodeAt(6)),s=16*se(e.charCodeAt(7))+se(e.charCodeAt(8));return new J(new G(t,o,n,s/255))}case 4:{const t=se(e.charCodeAt(1)),o=se(e.charCodeAt(2)),n=se(e.charCodeAt(3));return new J(new G(16*t+t,16*o+o,16*n+n))}case 5:{const t=se(e.charCodeAt(1)),o=se(e.charCodeAt(2)),n=se(e.charCodeAt(3)),s=se(e.charCodeAt(4));return new J(new G(16*t+t,16*o+o,16*n+n,(16*s+s)/255))}default:return null}}function se(e){switch(e){case F.Digit0:return 0;case F.Digit1:return 1;case F.Digit2:return 2;case F.Digit3:return 3;case F.Digit4:return 4;case F.Digit5:return 5;case F.Digit6:return 6;case F.Digit7:return 7;case F.Digit8:return 8;case F.Digit9:return 9;case F.a:case F.A:return 10;case F.b:case F.B:return 11;case F.c:case F.C:return 12;case F.d:case F.D:return 13;case F.e:case F.E:return 14;case F.f:case F.F:return 15}return 0}const re=class e{constructor(){this._disposed=!1}get event(){return null==this._event&&(this._event=(t,o,n)=>{null==this.listeners&&(this.listeners=new de);const s=this.listeners.push(null==o?t:[t,o]),r={dispose:()=>{r.dispose=e._noop,this._disposed||s()}};return Array.isArray(n)&&n.push(r),r}),this._event}fire(e){if(null!=this.listeners){null==this._deliveryQueue&&(this._deliveryQueue=new de);for(let t=this.listeners.iterator(),o=t.next();!o.done;o=t.next())this._deliveryQueue.push([o.value,e]);for(;this._deliveryQueue.size>0;){const[e,t]=this._deliveryQueue.shift();try{"function"==typeof e?e(t):e[0].call(e[1],t)}catch(e){}}}}dispose(){this.listeners?.clear(),this._deliveryQueue?.clear(),this._disposed=!0}};re._noop=function(){};let ie=re;const ae={done:!0,value:void 0},ce=class e{constructor(t){this.element=t,this.next=e.Undefined,this.prev=e.Undefined}};ce.Undefined=new ce(void 0);let le=ce;class de{constructor(){this._first=le.Undefined,this._last=le.Undefined,this._size=0}get size(){return this._size}isEmpty(){return this._first===le.Undefined}clear(){this._first=le.Undefined,this._last=le.Undefined,this._size=0}unshift(e){return this._insert(e,!1)}push(e){return this._insert(e,!0)}_insert(e,t){const o=new le(e);if(this._first===le.Undefined)this._first=o,this._last=o;else if(t){const e=this._last;this._last=o,o.prev=e,e.next=o}else{const e=this._first;this._first=o,o.next=e,e.prev=o}this._size+=1;let n=!1;return()=>{n||(n=!0,this._remove(o))}}shift(){if(this._first===le.Undefined)return;const e=this._first.element;return this._remove(this._first),e}pop(){if(this._last===le.Undefined)return;const e=this._last.element;return this._remove(this._last),e}_remove(e){if(e.prev!==le.Undefined&&e.next!==le.Undefined){const t=e.prev;t.next=e.next,e.next.prev=t}else e.prev===le.Undefined&&e.next===le.Undefined?(this._first=le.Undefined,this._last=le.Undefined):e.next===le.Undefined?(this._last=this._last.prev,this._last.next=le.Undefined):e.prev===le.Undefined&&(this._first=this._first.next,this._first.prev=le.Undefined);this._size-=1}iterator(){let e,t=this._first;return{next:function(){return t===le.Undefined?ae:(null==e?e={done:!1,value:t.element}:e.value=t.element,t=t.next,e)}}}toArray(){const e=[];for(let t=this._first;t!==le.Undefined;t=t.next)e.push(t.element);return e}}const he=new ie,fe=he.event;function pe(e){const t=document.documentElement,o=window.getComputedStyle(t),n=document.body.classList,s=n.contains("vscode-light")||n.contains("vscode-high-contrast-light"),r=n.contains("vscode-high-contrast")||n.contains("vscode-high-contrast-light"),i=t.style,a=K("--vscode-editor-background",o);let c=K("--vscode-editor-foreground",o);c||(c=K("--vscode-foreground",o));let l=K("--color-background",o);return i.setProperty("--color-background--lighten-05",I(l,5)),i.setProperty("--color-background--darken-05",V(l,5)),i.setProperty("--color-background--lighten-075",I(l,7.5)),i.setProperty("--color-background--darken-075",V(l,7.5)),i.setProperty("--color-background--lighten-10",I(l,10)),i.setProperty("--color-background--darken-10",V(l,10)),i.setProperty("--color-background--lighten-15",I(l,15)),i.setProperty("--color-background--darken-15",V(l,15)),i.setProperty("--color-background--lighten-30",I(l,30)),i.setProperty("--color-background--darken-30",V(l,30)),i.setProperty("--color-background--lighten-50",I(l,50)),i.setProperty("--color-background--darken-50",V(l,50)),l=K("--color-button-background",o),i.setProperty("--color-button-background--darken-30",V(l,30)),l=K("--color-highlight",o),i.setProperty("--color-highlight--75",N(l,75)),i.setProperty("--color-highlight--50",N(l,50)),i.setProperty("--color-highlight--25",N(l,25)),l=K("--color-button-secondary-background",o),i.setProperty("--color-button-secondary-background--darken-30",V(l,30)),l=K("--color-foreground",o),i.setProperty("--color-foreground--85",N(l,85)),i.setProperty("--color-foreground--75",N(l,75)),i.setProperty("--color-foreground--65",N(l,65)),i.setProperty("--color-foreground--50",N(l,50)),l=K("--color-link-foreground",o),i.setProperty("--color-link-foreground--darken-20",V(l,20)),i.setProperty("--color-link-foreground--lighten-20",I(l,20)),l=K("--color-alert-infoBackground",o),i.setProperty("--color-alert-infoHoverBackground",s?V(l,5):I(l,5)),l=K("--color-alert-warningBackground",o),i.setProperty("--color-alert-warningHoverBackground",s?V(l,5):I(l,5)),l=K("--color-alert-errorBackground",o),i.setProperty("--color-alert-errorHoverBackground",s?V(l,5):I(l,5)),l=s?V(a,5):I(a,5),i.setProperty("--color-alert-neutralBackground",l),i.setProperty("--color-alert-neutralHoverBackground",s?V(l,5):I(l,5)),{colors:{background:a,foreground:c},computedStyle:o,isLightTheme:s,isHighContrastTheme:r,isInitializing:null==e}}var be=Object.defineProperty,ue=Object.getOwnPropertyDescriptor;let ge=0;function ye(){return 1073741824===ge?ge=1:ge++,`webview:${ge}`}const xe=new TextDecoder;class ve{constructor(e){this.appName=e;const t=[],o=pe();if(null!=this.onThemeUpdated&&(this.onThemeUpdated(o),t.push(fe(this.onThemeUpdated,this))),this.state=window.bootstrap,window.bootstrap=void 0,this.placement=document.body.getAttribute("data-placement")??"editor",w.configure({name:e,createChannel:function(e){return{name:e,appendLine:function(e){}}}},"off"),this.log(`${e}()`),this._api=acquireVsCodeApi(),null!=this.state){const e=this.getState();this.state.timestamp>=(e?.timestamp??0)?this._api.setState(this.state):this.state=e}t.push(function(){const e=new MutationObserver((e=>{he.fire(pe(e))}));return e.observe(document.body,{attributeFilter:["class"]}),{dispose:()=>e.disconnect()}}()),requestAnimationFrame((()=>{this.log(`${e}(): initializing...`);try{this.onInitialize?.(),this.bind(),null!=this.onMessageReceived&&t.push(z.on(window,"message",(e=>this.onMessageReceivedCore(e)))),this.sendCommand(i,void 0),this.onInitialized?.()}finally{document.body.classList.contains("preload")&&setTimeout((()=>{document.body.classList.remove("preload")}),500)}})),t.push(z.on(window,"pagehide",(()=>{t?.forEach((e=>e.dispose())),this.bindDisposables?.forEach((e=>e.dispose())),this.bindDisposables=void 0})))}onMessageReceivedCore(e){const t=A.get(S),o=e.data;if(o.packed&&o.params instanceof Uint8Array){const n=function(e,t,...o){return(t?.provider??$).enabled(t?.logLevel??"info")?new U(e,t,...o):void 0}(E(` deserializing msg=${e.data.method}`,t),{log:!1,logLevel:"debug"});o.params=JSON.parse(xe.decode(o.params)),n?.stop()}this.onMessageReceived(o)}bind(){this.bindDisposables?.forEach((e=>e.dispose())),this.bindDisposables=this.onBind?.(),null==this.bindDisposables&&(this.bindDisposables=[]);const e=h((e=>{this.sendCommand(a,e)}),150);this.bindDisposables.push(z.on(document,"focusin",(t=>{const o=t.composedPath().some((e=>"INPUT"===e.tagName));!0===this._focused&&this._inputFocused===o||(this._focused=!0,this._inputFocused=o,e({focused:!0,inputFocused:o}))})),z.on(document,"focusout",(()=>{!1===this._focused&&!1===this._inputFocused||(this._focused=!1,this._inputFocused=!1,e({focused:!1,inputFocused:!1}))})))}log(e,...t){"string"==typeof e?w.log(e,...t):w.log(e,t.shift(),...t)}getState(){return this._api.getState()}sendCommand(e,t){const o=ye();this.log(`${this.appName}.sendCommand(${o}): name=${e.method}`),this.postMessage({id:o,method:e.method,params:t})}async sendCommandWithCompletion(e,t,o){const n=ye();this.log(`${this.appName}.sendCommandWithCompletion(${n}): name=${e.method}`);const s=new Promise(((e,t)=>{let s;const i=[z.on(window,"message",(t=>{r(o,t.data,(o=>{t.data.completionId===n&&(i.forEach((e=>e.dispose())),queueMicrotask((()=>e(o))))}))})),{dispose:function(){null!=s&&(clearTimeout(s),s=void 0)}}];s=setTimeout((()=>{s=void 0,i.forEach((e=>e.dispose())),t(new Error(`Timed out waiting for completion of ${o.method}`))}),6e4)}));return this.postMessage({id:n,method:e.method,params:t,completionId:n}),s}setState(e){this._api.setState(e)}postMessage(e){this._api.postMessage(e)}}var me;((e,t,o,n)=>{for(var s,r=n>1?void 0:n?ue(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);n&&r&&be(t,o,r)})([(me={args:{0:e=>`${e.data.id}, method=${e.data.method}`}},function(e,t=!1){let o,n,s,r,i=0,a=!1,c=!1,l=!0;null!=e&&({args:o,enter:n,exit:s,prefix:r,logThreshold:i=0,scoped:a=!0,singleLine:c=!1,timed:l=!0}=e),i>0&&(c=!0,l=!0),l&&(a=!0);const h=w.isDebugging,C=t?w.debug:w.log,_=h?"debug":"info";return(e,t,$)=>{let M,S;if("function"==typeof $.value?(M=$.value,S="value"):"function"==typeof $.get&&(M=$.get,S="get"),null==M||null==S)throw new Error("Not supported");const E=!1!==o?function(e){if("function"!=typeof e)throw new Error("Not supported");if(0===e.length)return[];let t=Function.prototype.toString.call(e);t=t.replace(v,p)||t,t=t.slice(0,t.indexOf(u));let o=t.indexOf(g),n=t.indexOf(y);o=o>=0?o+1:0,n=n>0?n:t.indexOf(b),t=t.slice(o,n),t=`(${t})`;const s=x.exec(t);return null!=s?s[1].split(f).map((e=>e.trim().replace(m,p))):[]}(M):[];$[S]=function(...e){if(!h&&!w.enabled(_))return M.apply(this,e);const f=D(),p=null!=this?this.constructor?.[H]?.(this,k(this))??k(this):void 0;let b,u=p?a?`[${f.toString(16).padStart(5)}] ${p}.${t}`:`${p}.${t}`:t;null!=r&&(u=r({id:f,instance:this,instanceName:p??B,name:t,prefix:u},...e)),a&&(b={scopeId:f,prefix:u},function(e,t){A.set(e,t)}(f,b));const g=null!=n?n(...e):B;let y;if(!1===o||0===e.length)y=B,c||C.call(w,`${u}${g}`);else{let t;y="";let n,s,r,i=-1;for(r of e){if(n=E[++i],t=o?.[i],null!=t){if("boolean"==typeof t)continue;if(y.length>0&&(y+=", "),"string"==typeof t){y+=t;continue}s=String(t(r))}else y.length>0&&(y+=", "),s=w.toLoggable(r);y+=n?`${n}=${s}`:s}c||C.call(w,y?`${u}${g}(${y})`:`${u}${g}`)}if(c||l||null!=s){const t=l?d():void 0,o=e=>{const o=void 0!==t?` [${Z(t)}ms]`:B;c?w.error(e,y?`${u}${g}(${y})`:`${u}${g}`,b?.exitDetails?`failed${b.exitDetails}${o}`:`failed${o}`):w.error(e,u,b?.exitDetails?`failed${b.exitDetails}${o}`:`failed${o}`),a&&P(f)};let n;try{n=M.apply(this,e)}catch(e){throw o(e),e}const r=e=>{let o,n,r,l;if(null!=t?(o=Z(t),o>L?(n=w.warn,r=` [*${o}ms] (slow)`):(n=C,r=` [${o}ms]`)):(r=B,n=C),null!=s)if("function"==typeof s)try{l=s(e)}catch(e){l=`@log.exit error: ${e}`}else!0===s&&(l=`returned ${w.toLoggable(e)}`);else b?.exitFailed?(l=b.exitFailed,n=w.error):l="completed";c?(0===i||o>i)&&n.call(w,y?`${u}${g}(${y}) ${l}${b?.exitDetails||B}${r}`:`${u}${g} ${l}${b?.exitDetails||B}${r}`):n.call(w,y?`${u}(${y}) ${l}${b?.exitDetails||B}${r}`:`${u} ${l}${b?.exitDetails||B}${r}`),a&&P(f)};return null!=n&&null!=(x=n)&&(x instanceof Promise||"function"==typeof x?.then)?n.then(r,o):r(n),n}var x;return M.apply(this,e)}}}(me,!0))],ve.prototype,"onMessageReceivedCore",1);const Ce=globalThis,we=Ce.ShadowRoot&&(void 0===Ce.ShadyCSS||Ce.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_e=Symbol(),ke=new WeakMap;class $e{constructor(e,t,o){if(this._$cssResult$=!0,o!==_e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(we&&void 0===e){const o=void 0!==t&&1===t.length;o&&(e=ke.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),o&&ke.set(t,e))}return e}toString(){return this.cssText}}const Le=(e,...t)=>{const o=1===e.length?e[0]:t.reduce(((t,o,n)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[n+1]),e[0]);return new $e(o,e,_e)},Me=we?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const o of e.cssRules)t+=o.cssText;return(e=>new $e("string"==typeof e?e:e+"",void 0,_e))(t)})(e):e,{is:Ae,defineProperty:Se,getOwnPropertyDescriptor:Pe,getOwnPropertyNames:Ee,getOwnPropertySymbols:De,getPrototypeOf:Fe}=Object,Oe=globalThis,Ze=Oe.trustedTypes,Be=Ze?Ze.emptyScript:"",He=Oe.reactiveElementPolyfillSupport,Ue=(e,t)=>e,ze={toAttribute(e,t){switch(t){case Boolean:e=e?Be:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let o=e;switch(t){case Boolean:o=null!==e;break;case Number:o=null===e?null:Number(e);break;case Object:case Array:try{o=JSON.parse(e)}catch(e){o=null}}return o}},Re=(e,t)=>!Ae(e,t),Te={attribute:!0,type:String,converter:ze,reflect:!1,hasChanged:Re};Symbol.metadata??=Symbol("metadata"),Oe.litPropertyMetadata??=new WeakMap;class Ve extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Te){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){const o=Symbol(),n=this.getPropertyDescriptor(e,o,t);void 0!==n&&Se(this.prototype,e,n)}}static getPropertyDescriptor(e,t,o){const{get:n,set:s}=Pe(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get(){return n?.call(this)},set(t){const r=n?.call(this);s.call(this,t),this.requestUpdate(e,r,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Te}static _$Ei(){if(this.hasOwnProperty(Ue("elementProperties")))return;const e=Fe(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Ue("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ue("properties"))){const e=this.properties,t=[...Ee(e),...De(e)];for(const o of t)this.createProperty(o,e[o])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,o]of t)this.elementProperties.set(e,o)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const o=this._$Eu(e,t);void 0!==o&&this._$Eh.set(o,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const o=new Set(e.flat(1/0).reverse());for(const e of o)t.unshift(Me(e))}else void 0!==e&&t.push(Me(e));return t}static _$Eu(e,t){const o=t.attribute;return!1===o?void 0:"string"==typeof o?o:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$Eg=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$ES(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$E_??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$E_?.delete(e)}_$ES(){const e=new Map,t=this.constructor.elementProperties;for(const o of t.keys())this.hasOwnProperty(o)&&(e.set(o,this[o]),delete this[o]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,t)=>{if(we)e.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const o of t){const t=document.createElement("style"),n=Ce.litNonce;void 0!==n&&t.setAttribute("nonce",n),t.textContent=o.cssText,e.appendChild(t)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$E_?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$E_?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,o){this._$AK(e,o)}_$EO(e,t){const o=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,o);if(void 0!==n&&!0===o.reflect){const s=(void 0!==o.converter?.toAttribute?o.converter:ze).toAttribute(t,o.type);this._$Em=e,null==s?this.removeAttribute(n):this.setAttribute(n,s),this._$Em=null}}_$AK(e,t){const o=this.constructor,n=o._$Eh.get(e);if(void 0!==n&&this._$Em!==n){const e=o.getPropertyOptions(n),s="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:ze;this._$Em=n,this[n]=s.fromAttribute(t,e.type),this._$Em=null}}requestUpdate(e,t,o,n=!1,s){if(void 0!==e){if(o??=this.constructor.getPropertyOptions(e),!(o.hasChanged??Re)(n?s:this[e],t))return;this.C(e,t,o)}!1===this.isUpdatePending&&(this._$Eg=this._$EP())}C(e,t,o){this._$AL.has(e)||this._$AL.set(e,t),!0===o.reflect&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$EP(){this.isUpdatePending=!0;try{await this._$Eg}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,o]of e)!0!==o.wrapped||this._$AL.has(t)||void 0===this[t]||this.C(t,this[t],o)}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$E_?.forEach((e=>e.hostUpdate?.())),this.update(t)):this._$ET()}catch(t){throw e=!1,this._$ET(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$E_?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Eg}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach((e=>this._$EO(e,this[e]))),this._$ET()}updated(e){}firstUpdated(e){}}Ve.elementStyles=[],Ve.shadowRootOptions={mode:"open"},Ve[Ue("elementProperties")]=new Map,Ve[Ue("finalized")]=new Map,He?.({ReactiveElement:Ve}),(Oe.reactiveElementVersions??=[]).push("2.0.2");const Ie=globalThis,Ne=Ie.trustedTypes,je=Ne?Ne.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ge="$lit$",qe=`lit$${(Math.random()+"").slice(9)}$`,We="?"+qe,Ke=`<${We}>`,Qe=document,Je=()=>Qe.createComment(""),Xe=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Ye=Array.isArray,et=e=>Ye(e)||"function"==typeof e?.[Symbol.iterator],tt="[ \t\n\f\r]",ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,nt=/-->/g,st=/>/g,rt=RegExp(`>|${tt}(?:([^\\s"'>=/]+)(${tt}*=${tt}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),it=/'/g,at=/"/g,ct=/^(?:script|style|textarea|title)$/i,lt=e=>(t,...o)=>({_$litType$:e,strings:t,values:o}),dt=lt(1),ht=lt(2),ft=Symbol.for("lit-noChange"),pt=Symbol.for("lit-nothing"),bt=new WeakMap,ut=Qe.createTreeWalker(Qe,129);function gt(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==je?je.createHTML(t):t}const yt=(e,t)=>{const o=e.length-1,n=[];let s,r=2===t?"<svg>":"",i=ot;for(let t=0;t<o;t++){const o=e[t];let a,c,l=-1,d=0;for(;d<o.length&&(i.lastIndex=d,c=i.exec(o),null!==c);)d=i.lastIndex,i===ot?"!--"===c[1]?i=nt:void 0!==c[1]?i=st:void 0!==c[2]?(ct.test(c[2])&&(s=RegExp("</"+c[2],"g")),i=rt):void 0!==c[3]&&(i=rt):i===rt?">"===c[0]?(i=s??ot,l=-1):void 0===c[1]?l=-2:(l=i.lastIndex-c[2].length,a=c[1],i=void 0===c[3]?rt:'"'===c[3]?at:it):i===at||i===it?i=rt:i===nt||i===st?i=ot:(i=rt,s=void 0);const h=i===rt&&e[t+1].startsWith("/>")?" ":"";r+=i===ot?o+Ke:l>=0?(n.push(a),o.slice(0,l)+Ge+o.slice(l)+qe+h):o+qe+(-2===l?t:h)}return[gt(e,r+(e[o]||"<?>")+(2===t?"</svg>":"")),n]};class xt{constructor({strings:e,_$litType$:t},o){let n;this.parts=[];let s=0,r=0;const i=e.length-1,a=this.parts,[c,l]=yt(e,t);if(this.el=xt.createElement(c,o),ut.currentNode=this.el.content,2===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(n=ut.nextNode())&&a.length<i;){if(1===n.nodeType){if(n.hasAttributes())for(const e of n.getAttributeNames())if(e.endsWith(Ge)){const t=l[r++],o=n.getAttribute(e).split(qe),i=/([.?@])?(.*)/.exec(t);a.push({type:1,index:s,name:i[2],strings:o,ctor:"."===i[1]?_t:"?"===i[1]?kt:"@"===i[1]?$t:wt}),n.removeAttribute(e)}else e.startsWith(qe)&&(a.push({type:6,index:s}),n.removeAttribute(e));if(ct.test(n.tagName)){const e=n.textContent.split(qe),t=e.length-1;if(t>0){n.textContent=Ne?Ne.emptyScript:"";for(let o=0;o<t;o++)n.append(e[o],Je()),ut.nextNode(),a.push({type:2,index:++s});n.append(e[t],Je())}}}else if(8===n.nodeType)if(n.data===We)a.push({type:2,index:s});else{let e=-1;for(;-1!==(e=n.data.indexOf(qe,e+1));)a.push({type:7,index:s}),e+=qe.length-1}s++}}static createElement(e,t){const o=Qe.createElement("template");return o.innerHTML=e,o}}function vt(e,t,o=e,n){if(t===ft)return t;let s=void 0!==n?o._$Co?.[n]:o._$Cl;const r=Xe(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(e),s._$AT(e,o,n)),void 0!==n?(o._$Co??=[])[n]=s:o._$Cl=s),void 0!==s&&(t=vt(e,s._$AS(e,t.values),s,n)),t}class mt{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:o}=this._$AD,n=(e?.creationScope??Qe).importNode(t,!0);ut.currentNode=n;let s=ut.nextNode(),r=0,i=0,a=o[0];for(;void 0!==a;){if(r===a.index){let t;2===a.type?t=new Ct(s,s.nextSibling,this,e):1===a.type?t=new a.ctor(s,a.name,a.strings,this,e):6===a.type&&(t=new Lt(s,this,e)),this._$AV.push(t),a=o[++i]}r!==a?.index&&(s=ut.nextNode(),r++)}return ut.currentNode=Qe,n}p(e){let t=0;for(const o of this._$AV)void 0!==o&&(void 0!==o.strings?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}}class Ct{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,n){this.type=2,this._$AH=pt,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=vt(this,e,t),Xe(e)?e===pt||null==e||""===e?(this._$AH!==pt&&this._$AR(),this._$AH=pt):e!==this._$AH&&e!==ft&&this._(e):void 0!==e._$litType$?this.g(e):void 0!==e.nodeType?this.$(e):et(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==pt&&Xe(this._$AH)?this._$AA.nextSibling.data=e:this.$(Qe.createTextNode(e)),this._$AH=e}g(e){const{values:t,_$litType$:o}=e,n="number"==typeof o?this._$AC(e):(void 0===o.el&&(o.el=xt.createElement(gt(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===n)this._$AH.p(t);else{const e=new mt(n,this),o=e.u(this.options);e.p(t),this.$(o),this._$AH=e}}_$AC(e){let t=bt.get(e.strings);return void 0===t&&bt.set(e.strings,t=new xt(e)),t}T(e){Ye(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let o,n=0;for(const s of e)n===t.length?t.push(o=new Ct(this.k(Je()),this.k(Je()),this,this.options)):o=t[n],o._$AI(s),n++;n<t.length&&(this._$AR(o&&o._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class wt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,n,s){this.type=1,this._$AH=pt,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=s,o.length>2||""!==o[0]||""!==o[1]?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=pt}_$AI(e,t=this,o,n){const s=this.strings;let r=!1;if(void 0===s)e=vt(this,e,t,0),r=!Xe(e)||e!==this._$AH&&e!==ft,r&&(this._$AH=e);else{const n=e;let i,a;for(e=s[0],i=0;i<s.length-1;i++)a=vt(this,n[o+i],t,i),a===ft&&(a=this._$AH[i]),r||=!Xe(a)||a!==this._$AH[i],a===pt?e=pt:e!==pt&&(e+=(a??"")+s[i+1]),this._$AH[i]=a}r&&!n&&this.O(e)}O(e){e===pt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class _t extends wt{constructor(){super(...arguments),this.type=3}O(e){this.element[this.name]=e===pt?void 0:e}}class kt extends wt{constructor(){super(...arguments),this.type=4}O(e){this.element.toggleAttribute(this.name,!!e&&e!==pt)}}class $t extends wt{constructor(e,t,o,n,s){super(e,t,o,n,s),this.type=5}_$AI(e,t=this){if((e=vt(this,e,t,0)??pt)===ft)return;const o=this._$AH,n=e===pt&&o!==pt||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==pt&&(o===pt||n);n&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Lt{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){vt(this,e)}}const Mt=Ie.litHtmlPolyfillSupport;Mt?.(xt,Ct),(Ie.litHtmlVersions??=[]).push("3.1.0");class At extends Ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,o)=>{const n=o?.renderBefore??t;let s=n._$litPart$;if(void 0===s){const e=o?.renderBefore??null;n._$litPart$=s=new Ct(t.insertBefore(Je(),e),e,void 0,o??{})}return s._$AI(e),s})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ft}}At._$litElement$=!0,At.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:At});const St=globalThis.litElementPolyfillSupport;St?.({LitElement:At});(globalThis.litElementVersions??=[]).push("4.0.2");const Pt=e=>(t,o)=>{void 0!==o?o.addInitializer((()=>{customElements.define(e,t)})):customElements.define(e,t)},Et={attribute:!0,type:String,converter:ze,reflect:!1,hasChanged:Re},Dt=(e=Et,t,o)=>{const{kind:n,metadata:s}=o;let r=globalThis.litPropertyMetadata.get(s);if(void 0===r&&globalThis.litPropertyMetadata.set(s,r=new Map),r.set(o.name,e),"accessor"===n){const{name:n}=o;return{set(o){const s=t.get.call(this);t.set.call(this,o),this.requestUpdate(n,s,e)},init(t){return void 0!==t&&this.C(n,void 0,e),t}}}if("setter"===n){const{name:n}=o;return function(o){const s=this[n];t.call(this,o),this.requestUpdate(n,s,e)}}throw Error("Unsupported decorator location: "+n)};function Ft(e){return(t,o)=>"object"==typeof o?Dt(e,t,o):((e,t,o)=>{const n=t.hasOwnProperty(o);return t.constructor.createProperty(o,n?{...e,wrapped:!0}:e),n?Object.getOwnPropertyDescriptor(t,o):void 0})(e,t,o)}var Ot=Object.defineProperty,Zt=Object.getOwnPropertyDescriptor,Bt=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?Zt(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&Ot(t,o,r),r};let Ht=class extends At{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};Ht.styles=Le`
		:host {
	...
	`,Bt([Ft()],Ht.prototype,"icon",2),Bt([Ft()],Ht.prototype,"modifier",2),Bt([Ft({type:Number})],Ht.prototype,"size",2),Ht=Bt([Pt("code-icon")],Ht);Le`
	.sr-only,
...
`;var Rt=Object.defineProperty,Tt=Object.getOwnPropertyDescriptor,Vt=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?Tt(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&Rt(t,o,r),r};let It=class extends At{constructor(){super(...arguments),this.full=!1,this.disabled=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.setAttribute("aria-disabled",this.disabled.toString()))}render(){const e=dt`<slot></slot>`;return null!=this.href?dt`<a href=${this.href}>${e}</a>`:e}};It.styles=[zt,Le`
			:host {
		...
		`],Vt([Ft({type:Boolean,reflect:!0})],It.prototype,"full",2),Vt([Ft({type:Boolean,reflect:!0})],It.prototype,"disabled",2),Vt([Ft({reflect:!0})],It.prototype,"density",2),Vt([Ft()],It.prototype,"href",2),Vt([Ft({reflect:!0})],It.prototype,"role",1),Vt([Ft()],It.prototype,"appearance",2),Vt([Ft({type:Number,reflect:!0})],It.prototype,"tabIndex",2),It=Vt([Pt("gl-button")],It);var Nt=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,Gt=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?jt(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&Nt(t,o,r),r};let qt=class extends At{render(){const e=dt`
			<div class="header">
		...
		`;return null!=this.href?dt`<a href=${this.href}>${e}</a>`:e}};qt.styles=[zt,Le`
			:host {
				display: block;
				padding: 1.6rem;
		...
		`],Gt([Ft()],qt.prototype,"href",2),qt=Gt([Pt("gk-card")],qt);var Wt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor;let Qt=class extends At{render(){return dt`<svg
			alt="GitLens"
			width="159"
			height="46"
			viewBox="0 0 159 46"
		...
		`],Qt=((e,t,o,n)=>{for(var s,r=n>1?void 0:n?Kt(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&Wt(t,o,r),r})([Pt("gitlens-logo")],Qt);var Jt=Object.defineProperty,Xt=Object.getOwnPropertyDescriptor,Yt=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?Xt(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&Jt(t,o,r),r};let eo=class extends At{render(){return dt`
	...
	`,Yt([Ft({type:Boolean,reflect:!0})],eo.prototype,"toggled",2),eo=Yt([Pt("gk-annotations-svg")],eo);var to=Object.defineProperty,oo=Object.getOwnPropertyDescriptor,no=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?oo(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&to(t,o,r),r};let so=class extends At{onMouseOver(){this.hovered=!0,this.hovering=this.inline}onMouseOut(){this.hovered=!0,this.hovering=!1}render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
	...
	`,no([Ft({type:Boolean,reflect:!0})],so.prototype,"inline",2),no([Ft({type:Boolean,reflect:!0})],so.prototype,"codelens",2),no([Ft({type:Boolean,reflect:!0})],so.prototype,"hovered",2),no([Ft({type:Boolean,reflect:!0})],so.prototype,"hovering",2),so=no([Pt("gk-blame-svg")],so);var ro=Object.defineProperty,io=Object.getOwnPropertyDescriptor,ao=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?io(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&ro(t,o,r),r};let co=class extends At{onClick(e){switch(e.target.dataset.feature){case"annotations":{this.annotationsToggled=!this.annotationsToggled;const e=document.getElementById("annotations");e.toggled=!e.toggled;break}case"revision":{this.revisionToggled=!this.revisionToggled;const e=document.getElementById("revision");e.toggled=!e.toggled;break}}this.dispatchEvent(new CustomEvent("click"))}render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
			<svg width="148" height="22" viewBox="-4 -3 147 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				${this.revision?ht`<rect class="icon__revision-bg" x="-4" y="-2.5" width="24" height="20.5" rx="4"/>`:""}
				...
				${this.annotationsToggled?ht`<g class="icon icon__annotations">
						...
						/>
				  </g>`:ht`<text y="16" class="icon ${this.annotations?"icon__annotations":"inactive"}"><tspan dx="75" class="glicon">&#xf113;</tspan></text>`}

				${this.revision?ht`<rect
						class="interactive"
	...
	`,ao([Ft({type:Boolean,reflect:!0})],co.prototype,"annotations",2),ao([Ft({type:Boolean,reflect:!0})],co.prototype,"revision",2),ao([Ft({type:Boolean,reflect:!0,attribute:"annotations-toggled"})],co.prototype,"annotationsToggled",2),ao([Ft({type:Boolean,reflect:!0,attribute:"revision-toggled"})],co.prototype,"revisionToggled",2),co=ao([Pt("gk-editor-toolbar-svg")],co);const lo=Le`
	:host {
		display: block;
		max-width: 69.2rem;
		width: calc(100% - 2rem);
...
`;var fo=Object.defineProperty,po=Object.getOwnPropertyDescriptor;let bo=class extends At{render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- a-prettier-ignore -->
		...
		`],bo=((e,t,o,n)=>{for(var s,r=n>1?void 0:n?po(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&fo(t,o,r),r})([Pt("gk-focus-svg")],bo);var uo=Object.defineProperty,go=Object.getOwnPropertyDescriptor;let yo=class extends At{render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
			<svg width="850" height="290" viewBox="0 0 850 290" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	`,yo=((e,t,o,n)=>{for(var s,r=n>1?void 0:n?go(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&uo(t,o,r),r})([Pt("gk-graph-svg")],yo);var xo=Object.defineProperty,vo=Object.getOwnPropertyDescriptor,mo=(e,t,o,n)=>{for(var s,r=n>1?void 0:n?vo(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&xo(t,o,r),r};let Co=class extends At{render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- prettier-ignore -->
			<svg width="600" height="44" viewBox="0 0 600 42" fill="none" xmlns="http://www.w3.org/2000/svg">
				<defs>
	...
	`,mo([Ft({type:Boolean,reflect:!0})],Co.prototype,"toggled",2),Co=mo([Pt("gk-revision-navigation-svg")],Co);var wo=Object.defineProperty,_o=Object.getOwnPropertyDescriptor;let ko=class extends At{render(){return dt`
	...
	`,ko=((e,t,o,n)=>{for(var s,r=n>1?void 0:n?_o(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&wo(t,o,r),r})([Pt("gk-timeline-svg")],ko);var $o=Object.defineProperty,Lo=Object.getOwnPropertyDescriptor;let Mo=class extends At{render(){return dt`
			<!-- Don't reformat or let prettier reformat the SVG otherwise whitespace will get added incorrect and screw up the positioning -->
			<!-- a-prettier-ignore -->
			<svg width="850" height="290" viewBox="0 0 850 290" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g>
		...
		`],Mo=((e,t,o,n)=>{for(var s,r=n>1?void 0:n?Lo(t,o):t,i=e.length-1;i>=0;i--)(s=e[i])&&(r=(n?s(t,o,r):s(r))||r);return n&&r&&$o(t,o,r),r})([Pt("gk-workspaces-svg")],Mo);var Ao=Object.defineProperty,So=Object.getOwnPropertyDescriptor;let Po=class extends At{render(){return dt`
			<a
				class="video-button"
